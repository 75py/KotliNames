...
fun <E : RealmObject> RealmQuery<E>.averageDouble(fieldName: KPropertyName<Double>) : Double = average(fieldName.name())
...
fun <E : RealmObject> RealmQuery<E>.maxDate(fieldName: KPropertyName<Date>) : Date = maximumDate(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.maxByte(fieldName: KPropertyName<Byte>) : Number = max(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.maxShort(fieldName: KPropertyName<Short>) : Number = max(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.maxInt(fieldName: KPropertyName<Int>) : Number = max(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.maxLong(fieldName: KPropertyName<Long>) : Number = max(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.maxFloat(fieldName: KPropertyName<Float>) : Number = max(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.maxDouble(fieldName: KPropertyName<Double>) : Number = max(fieldName.name())

fun <E : RealmObject> RealmQuery<E>.minDate(fieldName: KPropertyName<Date>) : Date = minimumDate(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.minByte(fieldName: KPropertyName<Byte>) : Number = min(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.minShort(fieldName: KPropertyName<Short>) : Number = min(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.minInt(fieldName: KPropertyName<Int>) : Number = min(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.minLong(fieldName: KPropertyName<Long>) : Number = min(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.minFloat(fieldName: KPropertyName<Float>) : Number = min(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.minDouble(fieldName: KPropertyName<Double>) : Number = min(fieldName.name())
...
fun <E : RealmObject> RealmQuery<E>.sumInt(fieldName: KPropertyName<Int>) : Number = sum(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.sumFloat(fieldName: KPropertyName<Float>) : Number = sum(fieldName.name())
fun <E : RealmObject> RealmQuery<E>.sumDouble(fieldName: KPropertyName<Double>) : Number = sum(fieldName.name())
